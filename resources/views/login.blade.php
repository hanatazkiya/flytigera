...
<body>
    <div class="w-50 container row vw-3 bg-body shadow-lg m-auto py-3" style="margin-top : 9vh !important">
        <h3 class="text-center">Login Untuk Melanjutkan</h3>
    </div>

    <div class="w-50 container row row-col-2 vw-3 pt-4 pb-5 mx-auto bg-body shadow" style="margin-top: 1vh;">
        <div class="col-5 mx-3">
            <img class="py-4 img img-fluid w-100" src="/images/guest-icon.png">
        ...
        <form class="col-6 m-auto" method="post" action="">
            @csrf
            ...
            <div class="row row-col-2 m-auto mt-4">
                <button type="submit" class="btn col-5 m-auto bg-orange-to-whitesmoke">Login</button>
                <a href="/register" class="btn col-5 m-auto bg-dark-cyan-to-whitesmoke">Register</a>
            </div>
        </form>
    </div>
