...
<body>
    ...
    <form class="w-50 m-5 container m-auto py-5" method="post" action="./post-place" enctype="multipart/form-data">
        @csrf
        <input readonly type="hidden" name="admin_id" value="{{ session('id') }}" class="form-control">
        <div class="mb-3">
            <label class="form-label" for="header_image">Gambar Header</label>
            <input required class="form-control" type="file" name="header_image">
        ...
        <div class="mb-3">
            ...
            <textarea required class="form-control" type="text" name="description" value="" style="height: 200px;"></textarea>
        ...
        <div class="mb-3">
            ...
            <input required class="form-control" name="short_description" value=""></input>
        ...
        <div class="mb-3">
            ...
            <input required class="form-control" type="text" name="slug" value="">
        ...
        <div class="mb-3">
            ...
            <input required class="form-control" type="text" name="embedded_maps" value="">
